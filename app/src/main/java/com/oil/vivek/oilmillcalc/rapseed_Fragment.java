 ...
 */
public class rapseed_Fragment extends Fragment {

    public static final String TAG = rapseed_Fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;
    TabHost tabHost;

    public static rapseed_Fragment newInstance() {
        return new rapseed_Fragment();
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            {
                case 0:
                    fragment = new rapseed_forward();
                    break;
                case 1:
                    fragment = new rapseed_reverse();
                    break;
            }
            return fragment;
        }
