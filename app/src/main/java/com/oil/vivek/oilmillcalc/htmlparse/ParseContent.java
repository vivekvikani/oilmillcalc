package com.oil.vivek.oilmillcalc.htmlparse;

import android.app.Activity;
import android.util.Log;

import com.oil.vivek.oilmillcalc.utils.AndyConstants;
import com.oil.vivek.oilmillcalc.utils.AppLog;
    ...
    public boolean isSuccess(String response) {
       ...
       /* if (TextUtils.isEmpty(response))
        ...
        try {
            ...
            //  Log.d("obj",jsonObject.optString(KEY_SUCCESS));

            if (jsonObject.optString(KEY_SUCCESS).equals("1")) {
                return true;
            } else {
               /* AndyUtils.showErrorToast(jsonObject.getInt(KEY_MSG),
                        activity);*/

                //  Log.d("error",""+jsonObject.getInt(KEY_MSG));
                return false;
            }
