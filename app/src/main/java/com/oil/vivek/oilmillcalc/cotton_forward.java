 ...
 */
public class cotton_forward extends Fragment implements View.OnClickListener, TextWatcher, View.OnFocusChangeListener{
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.cotton_forward_layout,container,false);
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i4, int i3) {
        ...
        for(EditText local : editTextList)
        {
            ...
            if(mySwitch.isChecked())
            {
                    double calcA = (a2Double*5)+(b2Double*d2Double)+((e2Double/20)*(c2Double+d2Double))-((f2Double/10)*(c2Double*(g2Double/100)));
                    double calcB = (c2Double+d2Double)-((c2Double*(g2Double/100))+((c2Double+d2Double)*(h2Double/100)));
                    double calcC = (calcA/calcB)*i2Double;
            ...
            {
                    double calcA = ((((a2Double+e2Double)*5)-((f2Double/10)*g2Double))/h2Double)*i2Double;
    ...
    public void onStop() {
        ...
        SharedPreferences appdata = PreferenceManager.getDefaultSharedPreferences(this.getActivity());
        SharedPreferences.Editor editor = appdata.edit();
        editor.putString("c1SP", a2.getText().toString());
        editor.putString("c2SP", b2.getText().toString());
        editor.putString("c3SP", c2.getText().toString());
        editor.putString("c4SP", d2.getText().toString());
        editor.putString("c5SP", e2.getText().toString());
        editor.putString("c6SP", f2.getText().toString());
        editor.putString("c7SP", g2.getText().toString());
        editor.putString("c8SP", h2.getText().toString());
        editor.putString("c9SP", i2.getText().toString());
        editor.putString("c10SP", ans2.getText().toString());
        editor.commit();
    }
}
