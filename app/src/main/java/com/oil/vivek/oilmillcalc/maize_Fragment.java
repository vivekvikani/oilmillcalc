 ...
 */
public class maize_Fragment extends Fragment {

    public static final String TAG = maize_Fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;
    TabHost tabHost;

    public static maize_Fragment newInstance() {
        return new maize_Fragment();
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            {
                case 0:
                    fragment = new maize_forward();
                    break;
                case 1:
                    fragment = new maize_reverse();
                    break;
            }
            return fragment;
        }
