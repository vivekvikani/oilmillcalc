 ...
 */
public class castor_forward extends Fragment implements View.OnClickListener, TextWatcher, View.OnFocusChangeListener{
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.castor_forward_layout,container,false);
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        for(EditText local : editTextList)
        {
            ...
            double calcA = ((((a2Double+b2Double)*5)-((100-d2Double-e2Double)*(c2Double/1000)))/d2Double)*10;
    ...
    public void onStop() {
        ...
        editor.putString("c1S", a2.getText().toString());
        editor.putString("c2S", b2.getText().toString());
        editor.putString("c3S", c2.getText().toString());
        editor.putString("c4S", d2.getText().toString());
        editor.putString("c5S", e2.getText().toString());
        editor.putString("c6S", ans2.getText().toString());
        editor.commit();
    }
}
