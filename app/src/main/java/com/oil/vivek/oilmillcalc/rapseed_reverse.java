 ...
 */
public class rapseed_reverse extends Fragment implements View.OnClickListener, TextWatcher, View.OnFocusChangeListener{
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.rapseed_reverse_layout,container,false);
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        for(EditText local : editTextList)
        {
            ...
            double calcA = (((a2Double/f2Double)*c2Double)+((e2Double/1000)*d2Double)-b2Double)/5;

                if(a2Double==0 || b2Double==0 || c2Double==0 || d2Double==0 || e2Double==0 || f2Double==0)
                {
                    calcA = 0;
                }
            ...
            if(calcA>0){
                ...
                String padtarFinal2 = String.format("%.2f", (calcA));
                ans22.setText(padtarFinal2);
            }else
            {

                ans22.setText("Invalid!!");
            }
    ...
    public void onStop() {
        ...
        editor.putString("rr1SP", a2.getText().toString());
        editor.putString("rr2SP", b2.getText().toString());
        editor.putString("rr3SP", c2.getText().toString());
        editor.putString("rr4SP", d2.getText().toString());
        editor.putString("rr5SP", e2.getText().toString());
        editor.putString("rr6SP", f2.getText().toString());
        editor.putString("rr7SP", ans22.getText().toString());
        editor.commit();
    }
}
