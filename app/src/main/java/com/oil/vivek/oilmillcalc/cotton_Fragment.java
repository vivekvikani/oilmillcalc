 ...
 */
public class cotton_Fragment extends Fragment {

    public static final String TAG = cotton_Fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;
    TabHost tabHost;

    public static cotton_Fragment newInstance() {
        return new cotton_Fragment();
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            {
                case 0:
                    fragment = new cotton_forward();
                    break;
                case 1:
                    fragment = new cotton_reverse();
                    break;
            }
            return fragment;
        }
