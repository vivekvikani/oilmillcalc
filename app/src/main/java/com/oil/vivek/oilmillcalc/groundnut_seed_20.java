 ...
 */
public class groundnut_seed_20 extends Fragment implements View.OnClickListener, TextWatcher, View.OnFocusChangeListener{
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.groundnut_seed_20_layout,container,false);
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        for(EditText local : editTextList)
        {
            ...
            double calcA = ((a2Double+b2Double)-(e2Double*(c2Double/20))-(f2Double*(d2Double/20)))/(20-e2Double-f2Double-g2Double);
    ...
    public void onStop() {
        ...
        editor.putString("gs1SP", a2.getText().toString());
        editor.putString("gs2SP", b2.getText().toString());
        editor.putString("gs3SP", c2.getText().toString());
        editor.putString("gs4SP", d2.getText().toString());
        editor.putString("gs5SP", e2.getText().toString());
        editor.putString("gs6SP", f2.getText().toString());
        editor.putString("gs7SP", g2.getText().toString());
        editor.putString("gs8SP", ans2.getText().toString());
        editor.commit();
    }
}
