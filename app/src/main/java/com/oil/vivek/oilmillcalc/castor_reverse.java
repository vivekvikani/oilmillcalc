 ...
 */
public class castor_reverse extends Fragment implements View.OnClickListener, TextWatcher, View.OnFocusChangeListener{
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.castor_reverse_layout,container,false);
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        for(EditText local : editTextList)
        {
            ...
            double calcA = ((((a2Double/10)*d2Double)+((c2Double/1000)*(100-d2Double-e2Double)))/5)-b2Double;

                if(a2Double==0 || b2Double==0 || c2Double==0 || d2Double==0 || e2Double==0)
                {
                    calcA = 0;
                }
    ...
    public void onStop() {
        ...
        editor.putString("cr1S", a2.getText().toString());
        editor.putString("cr2S", b2.getText().toString());
        editor.putString("cr3S", c2.getText().toString());
        editor.putString("cr4S", d2.getText().toString());
        editor.putString("cr5S", e2.getText().toString());
        editor.putString("cr6S", ans2.getText().toString());
        editor.commit();
    }
}
