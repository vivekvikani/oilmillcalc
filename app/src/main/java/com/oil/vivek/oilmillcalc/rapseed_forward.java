 ...
 */
public class rapseed_forward extends Fragment implements View.OnClickListener, TextWatcher, View.OnFocusChangeListener{
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.rapseed_forward_layout,container,false);
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        for(EditText local : editTextList)
        {
            ...
            double calcA = ((((a2Double*5)+b2Double)-((d2Double)*(e2Double/1000)))/c2Double)*f2Double;
    ...
    public void onStop() {
        ...
        editor.putString("r1SP", a2.getText().toString());
        editor.putString("r2SP", b2.getText().toString());
        editor.putString("r3SP", c2.getText().toString());
        editor.putString("r4SP", d2.getText().toString());
        editor.putString("r5SP", e2.getText().toString());
        editor.putString("r6SP", f2.getText().toString());
        editor.putString("r7SP", ans22.getText().toString());
        editor.commit();
    }
}
