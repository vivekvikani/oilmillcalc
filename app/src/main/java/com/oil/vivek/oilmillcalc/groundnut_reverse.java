 ...
 */
public class groundnut_reverse extends Fragment implements View.OnClickListener, TextWatcher, View.OnFocusChangeListener{
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.groundnut_reverse_layout,container,false);
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        for(EditText local : editTextList)
        {
            ...
            double calcA = ((b2Double*(a2Double/10))+(c2Double*(e2Double/1000))+(d2Double*(f2Double/20)))-g2Double;

            if(a2Double==0 || b2Double==0 || c2Double==0 || d2Double==0 || f2Double==0)
            {
                calcA = 0;
            }
    ...
    public void onStop() {
        ...
        editor.putString("gr1SP", a2.getText().toString());
        editor.putString("gr2SP", b2.getText().toString());
        editor.putString("gr3SP", c2.getText().toString());
        editor.putString("gr4SP", d2.getText().toString());
        editor.putString("gr5SP", e2.getText().toString());
        editor.putString("gr6SP", f2.getText().toString());
        editor.putString("gr7SP", g2.getText().toString());
        editor.putString("gr8SP", ans2.getText().toString());
        editor.commit();
    }
}
