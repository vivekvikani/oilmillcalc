 ...
 */
public class groundnut_forward extends Fragment implements View.OnClickListener, TextWatcher, View.OnFocusChangeListener{
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.groundnut_forward_layout,container,false);
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        for(EditText local : editTextList)
        {
            ...
            double calcA = (((a2Double + b2Double)-((d2Double*(f2Double/1000))+(e2Double*(g2Double/20))))/c2Double)*10;
    ...
    public void onStop() {
        ...
        editor.putString("g1SP", a2.getText().toString());
        editor.putString("g2SP", b2.getText().toString());
        editor.putString("g3SP", c2.getText().toString());
        editor.putString("g4SP", d2.getText().toString());
        editor.putString("g5SP", e2.getText().toString());
        editor.putString("g6SP", f2.getText().toString());
        editor.putString("g7SP", g2.getText().toString());
        editor.putString("g8SP", ans2.getText().toString());
        editor.commit();
    }
}
