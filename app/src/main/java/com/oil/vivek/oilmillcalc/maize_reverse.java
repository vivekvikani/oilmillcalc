 ...
 */
public class maize_reverse extends Fragment implements View.OnClickListener, TextWatcher, View.OnFocusChangeListener{
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.maize_reverse_layout,container,false);
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        for(EditText local : editTextList)
        {
            ...
            double calcA = (((((a2Double/h2Double)*g2Double)+((f2Double/10)*e2Double)-((b2Double/1000)*(100-c2Double)))*10)-d2Double)/(c2Double/100);

                if(a2Double==0 || b2Double==0 || c2Double==0 || d2Double==0 || f2Double==0 || e2Double==0 || g2Double==0 || h2Double==0)
                {
                    calcA = 0;
                }
            ...
            if(calcA>0){
                String padtarFinal = String.format("%.0f", calcA);
    ...
    public void onStop() {
        ...
        editor.putString("mr1SP", a2.getText().toString());
        editor.putString("mr2SP", b2.getText().toString());
        editor.putString("mr3SP", c2.getText().toString());
        editor.putString("mr4SP", d2.getText().toString());
        editor.putString("mr5SP", e2.getText().toString());
        editor.putString("mr6SP", f2.getText().toString());
        editor.putString("mr7SP", g2.getText().toString());
        editor.putString("mr8SP", h2.getText().toString());
        editor.putString("mr9SP", ans2.getText().toString());
        editor.commit();
    }
}
