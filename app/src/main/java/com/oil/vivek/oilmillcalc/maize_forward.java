 ...
 */
public class maize_forward extends Fragment implements View.OnClickListener, TextWatcher, View.OnFocusChangeListener{
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.maize_forward_layout,container,false);
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        for(EditText local : editTextList)
        {
            ...
            double calcA = ((((((a2Double*c2Double)+(b2Double*(100-c2Double)))/100)+d2Double)-((f2Double/10)*(e2Double*10)))/(g2Double*10))*h2Double;
    ...
    public void onStop() {
        ...
        editor.putString("m1SP", a2.getText().toString());
        editor.putString("m2SP", b2.getText().toString());
        editor.putString("m3SP", c2.getText().toString());
        editor.putString("m4SP", d2.getText().toString());
        editor.putString("m5SP", e2.getText().toString());
        editor.putString("m6SP", f2.getText().toString());
        editor.putString("m7SP", g2.getText().toString());
        editor.putString("m8SP", h2.getText().toString());
        editor.putString("m9SP", ans2.getText().toString());
        editor.commit();
    }
}
