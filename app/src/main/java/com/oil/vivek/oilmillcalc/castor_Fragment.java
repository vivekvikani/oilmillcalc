 ...
 */
public class castor_Fragment extends Fragment {

    public static final String TAG = castor_Fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;
    TabHost tabHost;

    public static castor_Fragment newInstance() {
        return new castor_Fragment();
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            {
                case 0:
                    fragment = new castor_forward();
                    break;
                case 1:
                    fragment = new castor_reverse();
                    break;
            }
            return fragment;
        }
